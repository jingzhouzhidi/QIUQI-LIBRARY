...
总负责：秋起.（AOR组）
特别鸣谢：霜泽图书馆及其附属群聊、白雪老师的完美教室及其附属群聊、PUMS（P社联合MODS）及其附属群聊、AOR（赤色极光）制作组、CR（天兆之国）制作组、TOD（亢龙有悔）制作组、AB（钢铁萌心）制作组、TCV（维城歧途）制作组、TTT（原神：切要关头）制作组等给予该项目大力支持的各大玩家群体。

鸣谢：
  阿列夫拾捌（CR组） - 为该项目及图书馆宣传，提供大量指导
  GuoSS怪（TOD组） - 为该项目及图书馆宣传
  西里斯-Sirius - 为图书馆所作宣传（MOD联合视频）
  
  希尔（AB组） - 所供诸多代码工具
  战国（新生） - 收录其代码案例、担任图书馆群聊管理
  幸好无声（胡桃） - 收录其大量代码模板、案例等、担任图书馆群聊管理
  希尔达（白雪群） - 收录其代码模板
  黑白平行（SPC组） - 收录其诸多代码工具、担任图书馆群聊管理
  MangGong（TCV组） - 收录其诸多代码工具
  zhizhong（德莉莎 from TTT组） - 提供大量教程
  九玖二柒9927 - 提供代码工具
  陈睿中之人 - 收录其代码工具
  ...
  BLO（AOR组） - 收录其代码工具
  波罗 - 提供代码模板、教程
  Y鱼の饼B（雨打芭蕉组） - 担任图书馆群聊管理，并为美工馆建设做出贡献
